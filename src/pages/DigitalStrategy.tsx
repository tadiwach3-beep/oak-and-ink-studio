...
import digitalPreview1 from "@/assets/digital-preview-1.jpg";
import digitalPreview2 from "@/assets/digital-preview-2.jpg";
import digitalPreview3 from "@/assets/digital-preview-3.jpg";

const DigitalStrategy = () => {
  const projects = [
    {
      image: digitalPreview1,
      title: "Maximalist Campaign",
      client: "Fashion Brand",
      results: "300% engagement boost",
      description: "Bold visual strategy that broke through the noise and captured attention."
    },
    {
      image: digitalPreview2,
      title: "Social Media Overhaul",
      client: "Tech Startup",
      results: "2M+ followers gained",
      description: "Strategic content flow that built a thriving community."
    },
    {
      image: digitalPreview3,
      title: "Brand Identity System",
      client: "Financial Services",
      results: "Brand recall +180%",
      description: "Cohesive metallic identity that commands trust and attention."
    }
  ];
      ...
      <header className="metallic-gradient py-16 md:py-24 relative overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg md:text-xl text-foreground/90 max-w-3xl">
            Maximalist approaches for bold market impact. We create strategies that command attention and drive results.
          </p>
        </div>
      </header>
      ...
      <section className="py-12 bg-card/50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-4xl md:text-5xl font-bold neon-glow mb-2">200%</div>
              <div className="text-muted-foreground">Average Growth Rate</div>
            </div>
            <div>
              <div className="text-4xl md:text-5xl font-bold neon-glow mb-2">5M+</div>
              <div className="text-muted-foreground">Impressions Generated</div>
            </div>
            <div>
              <div className="text-4xl md:text-5xl font-bold neon-glow mb-2">150+</div>
      ...
      <section className="metallic-gradient py-16 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg mb-8 text-foreground/90">
            Let's craft a digital strategy that sets you apart from the competition.
          </p>
          <Link to="/#contact">
